...
impl MetricsCollector {
    ...
    pub fn record_request(
        ...
        self.total_cost_cents
            .fetch_add((cost * 10000.0) as i64, Ordering::Relaxed);
    ...
    pub fn snapshot(&self) -> serde_json::Value {
        ...
        for entry in self.by_model.iter() {
            ...
            models.insert(
                ...
                serde_json::json!({
                    ...
                    "cost_yuan": entry.cost_cents.load(Ordering::Relaxed) as f64 / 10000.0,
        ...
        serde_json::json!({
            ...
            "total_cost_yuan": self.total_cost_cents.load(Ordering::Relaxed) as f64 / 10000.0,
